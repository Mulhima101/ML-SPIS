...
def get_student_knowledge_summary(student_id):
    ...
    # For simplicity, we'll use equal weights for all topics
    topic_scores = {kl.topic: kl.score for kl in knowledge_levels}
    topic_weights = {kl.topic: 1.0 for kl in knowledge_levels}
    
    overall_score = calculate_overall_score(topic_scores, topic_weights)
