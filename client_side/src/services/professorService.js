...
export const updateProfessorProfile = async (professorId, profileData) => {
  try {
    const response = await axios.put(`${API_URL}/professors/${professorId}/profile`, profileData);
    return response.data;
  } catch (error) {
...
export const getAllStudents = async () => {
  try {
    ...
    throw error.response ? error.response.data : new Error('Failed to get students');
  }
};
...
export const getStudentDetails = async (studentId) => {
  try {
    ...
    throw error.response ? error.response.data : new Error('Failed to get student details');
  }
};
...
export const getStudentKnowledge = async (studentId) => {
  try {
    ...
    throw error.response ? error.response.data : new Error('Failed to get student knowledge');
  }
};
...
export const getStudentQuizzes = async (studentId) => {
  try {
    ...
    throw error.response ? error.response.data : new Error('Failed to get student quizzes');
  }
};
...
export const getDashboardData = async () => {
  try {
    ...
    throw error.response ? error.response.data : new Error('Failed to get dashboard data');
  }
};
